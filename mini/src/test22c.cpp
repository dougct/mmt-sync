/*
 * 
 * This example is used to try to synchronize when there is a divergence due to indirect call (or virtual functions) and the called functions call the same big function.
 * 
 * stack_size(small_fun1) < stack_size(big_fun)
 * 
 */
