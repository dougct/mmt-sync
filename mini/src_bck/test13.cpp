/*
 * This is an 'if' statement without 'else' where 'then' calls a big function.
 * The PC of big function is larger than the calling function.
 * 
 * This is an example where Long will fail because it will execute the big code twice.
 * 
 * 
 */
